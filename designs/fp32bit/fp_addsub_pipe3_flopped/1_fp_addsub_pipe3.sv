...
module fp_addsub_pipe3 #(
  ...
  parameter int SIG = 24
    ...
    logic [E+S:0] z_rec_reg, z_rec_reg_t;
    logic [4:0] exceptionFlags_reg, exceptionFlags_reg_t;
    logic sub_reg;
    ...
    always_ff @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            z_ieee_reg <= z_ieee_reg_t | (z_rec_reg_t | b_rec_reg_t | a_rec_reg_t); // for timing and avoiding optimisation out
        end
    end

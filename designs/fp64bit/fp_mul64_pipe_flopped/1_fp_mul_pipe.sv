...
// fpMultiplier.sv
// IEEE Floating Point multiplier - pipelined
...
PipelinedRadix4BoothWallace53 mult(.signedFlag(1'b0), .multiplicand(xMantissa), .multiplier(yMantissa), .out(prod), .clk(clk), .run(1'b1));
